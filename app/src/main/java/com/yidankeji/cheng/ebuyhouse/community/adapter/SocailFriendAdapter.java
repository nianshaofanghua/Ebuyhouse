...
public class SocailFriendAdapter extends BaseAdapter implements SectionIndexer {
    private ArrayList<SocialFriendBean.ContentBean.RowsBean> mList;
    private Context mContext;

    public SocailFriendAdapter(ArrayList<SocialFriendBean.ContentBean.RowsBean> list, Context context) {
        mList = list;
        mContext = context;
