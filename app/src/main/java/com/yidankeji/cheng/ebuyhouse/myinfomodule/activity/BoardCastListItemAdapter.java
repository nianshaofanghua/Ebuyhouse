...
public class BoardCastListItemAdapter extends BaseAdapter {
    ArrayList<BoardCastModel.ContentBean.RowsBean.RadioMsgBean> mList;
    Context mContext;

    public BoardCastListItemAdapter(ArrayList<BoardCastModel.ContentBean.RowsBean.RadioMsgBean> list, Context context) {
        mList = list;
        mContext = context;
    }
