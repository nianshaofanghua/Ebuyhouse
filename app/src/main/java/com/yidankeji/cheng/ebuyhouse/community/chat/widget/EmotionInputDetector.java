package com.yidankeji.cheng.ebuyhouse.community.chat.widget;
...
import com.yidankeji.cheng.ebuyhouse.community.chat.util.AudioRecoderUtils;
import com.yidankeji.cheng.ebuyhouse.community.chat.util.PopupWindowFactory;
...
public class EmotionInputDetector {
    ...
    public EmotionInputDetector bindToVoiceButton(final View voiceButton) {
        ...
        voiceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mVoiceText.isShown()) {
                    ImageView voice = (ImageView) voiceButton;
                    voice.setImageResource(R.mipmap.keybord);
                }else {
                    ImageView voice = (ImageView) voiceButton;
                    voice.setImageResource(R.mipmap.icon_chat_voice);
                }
            }
        });
        return this;
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        mVoiceText.setText("Loosen the end");
                        mPopVoiceText.setText("Slide on the finger, cancel sending");
                        mVoiceText.setTag("1");
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        mVoiceText.setText("Press the talk");
                        mVoiceText.setTag("3");
