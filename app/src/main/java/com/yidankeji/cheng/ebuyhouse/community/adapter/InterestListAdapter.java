...
public class InterestListAdapter extends BaseAdapter  implements SectionIndexer {
    ArrayList<InterestListModel.ContentBean.RowsBean> mList;
    Context mContext;

    public InterestListAdapter(ArrayList<InterestListModel.ContentBean.RowsBean> listModels, Context context) {
        mList = listModels;
        mContext = context;

    }

    public void setList(ArrayList<InterestListModel.ContentBean.RowsBean> list) {
        mList = list;
        notifyDataSetChanged();
    }

    public ArrayList<InterestListModel.ContentBean.RowsBean> getList() {
        return mList;
    }
