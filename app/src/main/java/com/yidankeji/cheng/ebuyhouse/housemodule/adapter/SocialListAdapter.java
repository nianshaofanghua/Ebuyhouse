...
public class SocialListAdapter extends BaseAdapter  implements SectionIndexer {
    private ArrayList<SocialListModel.ContentBean.RowsBean> mList;
    private Context mContext;

    public SocialListAdapter(ArrayList<SocialListModel.ContentBean.RowsBean> list, Context context) {
        mList = list;
        mContext = context;

    }

    public void setList(ArrayList<SocialListModel.ContentBean.RowsBean> list) {
        mList = list;
        notifyDataSetChanged();
    }

    public ArrayList<SocialListModel.ContentBean.RowsBean> getList() {
        return mList;
    }
    ...
    InterestFriendAdapter.OnClicking mOnClicking;
    public void setOnClickListen(InterestFriendAdapter.OnClicking onClickListen){
